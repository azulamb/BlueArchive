...
type ANOTHER_TYPE = 'normal' | 'swimsuit' | 'riding' | 'bunny_girl' | 'maid' | 'new_year' | 'sportswear' | 'christmas' | 'hot_spring' | 'cheerleader' | 'kid' | 'casual' | 'camp' | 'dress' | 'guide' | 'band' | 'combat' | 'qipao' | 'idol' | 'pajamas' | 'uniform';
